...
namespace Delphinus.Builders.Query.Filters
{
    /// <summary>
    ...
    public sealed partial class WhereBuilder
    {
        ...
        /// </param>
        /// <returns>
        /// The current <see cref="WhereBuilder"/> instance.
        /// </returns>
        private WhereBuilder AddGroup(
            bool isNot,
            bool isAndOr,
            params string[] conditions)
        {
            ...
            var operatorOrAnd = isAndOr ? " OR " : " AND ";
            var operatorNot = isNot ? "NOT " : string.Empty;

            var group = string.Join(operatorOrAnd, valid);
            var clause = $"{operatorNot}({group})";
        ...
        /// <see cref="WhereBuilder"/> instance.
        ///
        ...
        /// An action that receives a new <see cref="WhereBuilder"/> instance
        ...
        /// The current <see cref="WhereBuilder"/> instance.
        /// </returns>
        private WhereBuilder AddAndOrGroup(
            bool isNot,
            params string[] conditions)
            => AddGroup(
                isNot,
        ...
        /// The current <see cref="WhereBuilder"/> instance.
        /// </returns>
        private WhereBuilder AddOrAndGroup(
            bool isNot,
            params string[] conditions)
            => AddGroup(
                isNot,
